...
def split_an_expense(group_name,split_member_names,amount,expence_name,paidby):
  # show_group_name()
  ...
  for i in range(member_count-1):
    query = query + split_member_names[i] + ","
  query = query + split_member_names[-1]+")"+ " VALUE("+"'"+expence_name+"'," +"'"+ paidby+"'" +","
  print(equal_split)
  print(query)
